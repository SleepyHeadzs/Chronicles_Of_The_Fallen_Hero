...
static DialogueLine lines[]={
    ...
    {"The Last Name on the Door", "Narration", "Some people carry the war inside them even after the battlefield has gone quiet. Torelius is one of them.", "scene_door.png"},
    ...
    {"The Last Name on the Door", "Narration", "For fifteen years, Valdris has called the Battle of Ashfeld a 'victory'. Torelius has never once used that word.", "scene_door.png"},
    {"The Last Name on the Door", "Narration", "Five thousand soldiers marched into that valley. Two thousand returned. The king held a parade. Torelius didn't go. He stood at the city gate counting the faces that were missing, and when he finished counting those, he started counting the ones who came back but came back 'wrong' — quieter, emptier, trembling for no reason.", "scene_door.png"},
    ...
    {"The Last Name on the Door", "Narration", "Torelius looked at it for a long time. He didn't call for Serenius. He didn't go back inside. He just knelt and studied the letters, and quietly said to no one:", "scene_door.png"},
    {"The Last Name on the Door", "Torelius", "So you're alive.", "Torelius.png"},
    {"The Last Name on the Door", "Narration", "He had always suspected.", "Torelius.png"},
    {"The Last Name on the Door", "Torelius", "--- --- ---", "Torelius.png"},
    {"The Last Name on the Door", "[Sakharin — now seen only in shadow]", "Somewhere beyond the row of trees, a shadowy figure stops walking. Turns. Looks toward the light in Torelius's window. After fifteen years of enemy captivity — fifteen years of silence, darkness, and a king who declared him dead — Sakharin has learned one thing with total clarity: Torelius was never the enemy.", "Sakharin.png"},
    {"The Last Name on the Door", "[Serenius — the weight he carries]", "Serenius learns about the name on the door the same way he learns most things: Torelius tells him, and he goes completely still. His face does the thing it always does — reveals nothing. He's practiced this for fifteen years. He's had to.", "Serenius.png"},
