...
static void ShowChapterCard(int chapter){
    ...
    chapterCardTimer=2.0f; //For how much time
...
void InitGame(void){
    ...
    if(backgroundMusic.frameCount>0){
        ...
        SetMusicVolume(backgroundMusic,0.75f); //Music Volume
...
void UpdateGame(void){
    ...
    switch(state){
        ...
        case STATE_ROUTE_CHOICE:{
            ...
            Rectangle fightButton={330,320,280,70}; //button Position
            Rectangle quizButton={670,320,280,70};
            if(CheckCollisionPointRec(mouse,fightButton))routeSelected=0; //fight 0, puzzle 1
        ...
        case STATE_CH1_BATTLE:
            ...
            else if(IsBattleFinished()==-1){ //battle --> puzzle --> battle...
                InitPuzzleSystem(1);
        ...
        case STATE_CHOICE: //ending choices
            {
                Vector2 mouse=GetMousePosition();
                choiceSelected=-1;
        ...
        case STATE_BAD_ENDING_BATTLE:
            ...
            else if(IsBattleFinished()==-1) InitBattleSystem(6); //bad -->6, boss --> 7
            break;
...
void DrawGame(void){
    switch(state){
        ...
        case STATE_CHAPTER_CARD:{
            static const char *numbers[5]={"CHAPTER I","CHAPTER II","CHAPTER III","CHAPTER IV","CHAPTER V"}; //chap number + name
            ...
            DrawText(name,640-MeasureText(name,25)/2,335,25,(Color){235,220,190,255}); //all about colors
            break;
        }
        ...
        case STATE_ROUTE_CHOICE:{ //formatting on thr screen
